        ...
        <div className='container'>
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
                ...
                <div className='py-10 pl-5 bg-gradient-to-br from-black/90 to-black/70 text-white rounded-3xl relative h-[320px] flex items-end'>
                    ...
                    <img src={Image1} alt="" className='w-[320px] absolute -right-6 bottom-0' />
                </div>
                ...
                <div className='py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-[320px] flex items-end'>
                    ...
                    <img src={Image2} alt="" className='w-[300px] absolute -right-11 lg:top-[10px]' />
                </div>

                {/* Third Col */}

                <div className='col-span-2 py-10 pl-10 bg-gradient-to-br from-primary to-primary/90 text-white rounded-3xl relative h-[320px] flex items-end'>
                    <div>
                        <div className='mb-4'>
                            <p className='mb-[2px] text-white'>Enjoy</p>
                            <p className='text-2xl font-semibold mb-[2px]'>With</p>
